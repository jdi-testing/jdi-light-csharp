...
namespace JDI.Light.Tests.Tests.Complex
{
    public class CheckListTests
    {
        ...
        private ICheckList<Enums.CheckboxElements> _nature()
        {
        ...
        {
            _nature().Select(Enums.CheckboxElements.Fire);
            CommonActionsData.CheckAction("Fire: condition changed to true");
        }
        ...
        {
            _nature().Select(Enums.CheckboxElements.Water, Enums.CheckboxElements.Fire);
            CommonActionsData.CheckAction("Fire: condition changed to true");
            _cheсkAllLogMessages(new List<string> {"Fire", "Water"});
        }
        ...
        {
            _nature().Check(Enums.CheckboxElements.Fire);
            CommonActionsData.CheckAction("Fire: condition changed to true");
        }
        ...
        {
            _nature().Check(Enums.CheckboxElements.Water, Enums.CheckboxElements.Fire);
            CommonActionsData.CheckAction("Fire: condition changed to true");
            _cheсkAllLogMessages(new List<string> {"Fire", "Water"});
        }
